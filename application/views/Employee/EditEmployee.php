    ...
    <div class="card-body">
        ...
        <div class="col-6 text-right">
            <button class="btn btn-outline-danger" data-toggle="modal" data-target="#exampleModal">
                <i class="fas fa-archive"></i></i>&nbsp Archive Employee
            </button>
        </div>
        </div>
        <div class="container">
        ...
        form.addEventListener('submit', function(event) {
            ...
            $.ajax({
                ...
                success: function(result){
                    $("#AlertDiv").html('<div class="alert alert-success" role="alert">Employee Edited<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                },
